...
# Generation date: 2023-11-12T16:13:36
...
class Dataset(NamedThing):
    ...
    class_class_uri: ClassVar[URIRef] = DATALAD_SCHEMA["Dataset"]
    class_class_curie: ClassVar[str] = "datalad_schema:Dataset"
...
slots.id = Slot(uri=SCHEMA.identifier, name="id", curie=SCHEMA.curie('identifier'),
                   model_uri=DATALAD_SCHEMA.id, domain=None, range=URIRef)
...
slots.primary_email = Slot(uri=SCHEMA.email, name="primary_email", curie=SCHEMA.curie('email'),
                   model_uri=DATALAD_SCHEMA.primary_email, domain=None, range=Optional[str])

slots.birth_date = Slot(uri=SCHEMA.birthDate, name="birth_date", curie=SCHEMA.curie('birthDate'),
                   model_uri=DATALAD_SCHEMA.birth_date, domain=None, range=Optional[Union[str, XSDDate]])

slots.age_in_years = Slot(uri=DATALAD_SCHEMA.age_in_years, name="age_in_years", curie=DATALAD_SCHEMA.curie('age_in_years'),
                   model_uri=DATALAD_SCHEMA.age_in_years, domain=None, range=Optional[int])

slots.vital_status = Slot(uri=DATALAD_SCHEMA.vital_status, name="vital_status", curie=DATALAD_SCHEMA.curie('vital_status'),
                   model_uri=DATALAD_SCHEMA.vital_status, domain=None, range=Optional[Union[str, "PersonStatus"]])
...
slots.datasetCollection__entries = Slot(uri=DATALAD_SCHEMA.entries, name="datasetCollection__entries", curie=DATALAD_SCHEMA.curie('entries'),
                   model_uri=DATALAD_SCHEMA.datasetCollection__entries, domain=None, range=Optional[Union[Dict[Union[str, DatasetId], Union[dict, Dataset]], List[Union[dict, Dataset]]]])

slots.Dataset_primary_email = Slot(uri=SCHEMA.email, name="Dataset_primary_email", curie=SCHEMA.curie('email'),
                   model_uri=DATALAD_SCHEMA.Dataset_primary_email, domain=Dataset, range=Optional[str],
